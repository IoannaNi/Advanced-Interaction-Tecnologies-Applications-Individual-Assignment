...
# 3rd Deliverable 
Για το τριτο παραδοτέο πρόσθεσα κάποιες "if" όπου που αντιστοιχούν σε όλες τις επιλογές και για την κάθε επιλογή γίνετε οι αλλαγές, μετασχηματισμοί κλπ..   
Στην συνέχεια όταν τα βγάζει "φεύγουν" οι ρυθμίσεις. 

Με το σχήμα 0 εισάγω και να περιστρέφω την εικόνα:  

![](dpsdXXXXX/Screenshot%20(11).png)

![](dpsdXXXXX/Screenshot%20(15).png)

Με το σχήμα 2 κάνω zoom in zoom out την εικόνα:  

![](dpsdXXXXX/Screenshot%20(12).png)

Με το 3 σχήμα αλλάζω το χρώμα σε μπλε και ρυθμίζω την πυκνότητα του χρώματος:
...
Αρχικά επιλέγω τον προσομοιωτή  για την διαδικασία του προγραμματισμού και σχεδιασμού για τον ευκολότερο έλεγχο. Επίσης δεν υπάρχει φόβος για βλάβες. Ενώ την κανονική κάμερα όταν είναι στο τελικό στάδιο της, δλδ της πρωτοτυποποίησης.
